...
Line 1: Locality / Village (e.g., `Doliyoh Ka Bass`)
Line 2: District + Division (e.g., `Sikar Jaipur Division`)
Line 3: State (e.g., `Rajasthan`)

**Full Formatted Address (comma-separated, for camera UI, inspection record, export, watermark, logs):**
Street/road, Area/sublocality, City/locality, State, Postal code, Country
Example: `Police Lines, Sikar, Rajasthan 332001, India`

**Removals:**
- Plus Codes (e.g., `J552+GM9`)
- Administrative divisions: `Jaipur Division`, `Revenue Division`, `Subdivision`, `Tehsil` (unless no city available)
- Country name included at end

Empty values skipped, joined with `, `.
